...
describe('useModuleStatus', () => {
    ...
    test('has loading state', async () => {
        ...
        expect(container.textContent).toMatchInlineSnapshot(`"{\\"isLoading\\":true,\\"error\\":null}"`);
        await act(nextTick);
        expect(container.textContent).toMatchInlineSnapshot(`"{\\"isLoading\\":false,\\"value\\":{\\"isSupported\\":true,\\"isUpToDate\\":true,\\"outdated\\":[],\\"installed\\":{\\"sanity\\":\\"3.0.0\\"}},\\"error\\":null}"`);
    });
    test('has no loading state when cached', async () => {
        ...
        expect(container.textContent).toMatchInlineSnapshot(`"{\\"isLoading\\":false,\\"value\\":{\\"isSupported\\":true,\\"isUpToDate\\":true,\\"outdated\\":[],\\"installed\\":{\\"sanity\\":\\"3.0.1\\"}},\\"error\\":null}"`);
    });
});
function getMockClient(response) {
    ...
    const mockClient = { observable };
    return mockClient;
}
function nextTick() {
    return new Promise((resolve) => setTimeout(resolve, 10));
}
//# sourceMappingURL=moduleStatus.test.js.map