...
export declare type WrappedOperation<ErrorStrings> = {
...
export declare type Operation<DisabledReasons = false> = GuardedOperation | WrappedOperation<DisabledReasons>;
