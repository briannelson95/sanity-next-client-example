...
export function useDocumentType(documentId, specifiedType = '*') {
    ...
    const SYNC_RESOLVED_STATE = useMemo(() => ({ documentType: specifiedType, isLoaded: true }), [specifiedType]);
    ...
    useEffect(() => {
        ...
        const sub = documentStore
            ...
            .subscribe((documentType) => setDocumentType({ documentType, isLoaded: true }));
...
//# sourceMappingURL=useDocumentType.js.map