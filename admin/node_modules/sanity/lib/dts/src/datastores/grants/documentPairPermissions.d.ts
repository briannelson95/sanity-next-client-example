 ...
 */
export declare function getDocumentPairPermissions({ client, grantsStore, schema, id, permission, type, }: DocumentPairPermissionsOptions): Observable<PermissionCheckResult>;
/**
 ...
 */
export declare const useDocumentPairPermissionsFromHookFactory: (args_0: DocumentPairPermissionsOptions) => import("../../util/createHookFromObservableFactory").LoadingTuple<PermissionCheckResult | undefined>;
export declare function useDocumentPairPermissions({ id, type, permission, ...rest }: PartialExcept<DocumentPairPermissionsOptions, 'id' | 'type' | 'permission'>): ReturnType<typeof useDocumentPairPermissionsFromHookFactory>;
