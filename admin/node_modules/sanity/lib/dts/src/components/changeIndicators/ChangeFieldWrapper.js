...
export const ChangeFieldWrapper = (props) => {
    ...
    return (React.createElement("div", { ref: ref, onClick: handleClick, onMouseLeave: onMouseLeave, onMouseEnter: onMouseEnter }, props.children));
};
...
//# sourceMappingURL=ChangeFieldWrapper.js.map