...
export const ChangeBarWrapper = styled.div(({ changed, disabled, isReviewChangeOpen }) => {
    if (disabled)
        return css `
      ${ChangeBar} {
        display: none;
...
`;
export const ChangeBarMarker = styled.div(({ theme }) => {
...
export const ChangeBarButton = styled.button(({ theme, $withHoverEffect }) => {
    /* these colours aren't freely available on the current theme */
    const notSelectedColor = theme.sanity.color.spot.yellow;
    return css `
      appearance: none;
...
//# sourceMappingURL=ElementWithChangeBar.styled.js.map