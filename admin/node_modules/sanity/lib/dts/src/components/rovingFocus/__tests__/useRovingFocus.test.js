...
function RenderTestComponent(props) {
    ...
    return (React.createElement(ThemeProvider, { theme: studioTheme },
        React.createElement(Card, { ref: setRootElement, id: "rootElement" },
            React.createElement(Button, { text: "Test", disabled: withDisabledButtons }),
...
describe('base/useRovingFocus:', () => {
    ...
    it('horizontal direction', () => {
        const { container } = render(React.createElement(RenderTestComponent, null));
    ...
    it('vertical direction', () => {
        const { container } = render(React.createElement(RenderTestComponent, { direction: "vertical" }));
        const rootElement = container.querySelector('#rootElement');
        const buttons = rootElement.querySelectorAll('button');
        // Focus button #0 on tab
        userEvent.tab();
    ...
    it('with disabled buttons', () => {
        const { container } = render(React.createElement(RenderTestComponent, { withDisabledButtons: true }));
        const rootElement = container.querySelector('#rootElement');
        const buttons = rootElement.querySelectorAll('button');
     ...
     */
    it('without loop', () => {
        const { container } = render(React.createElement(RenderTestComponent, { loop: false }));
        const rootElement = container.querySelector('#rootElement');
        const buttons = rootElement.querySelectorAll('button');
        // Focus button #0 on tab
        userEvent.tab();
    ...
    it('initial focus last', () => {
        const { container } = render(React.createElement(RenderTestComponent, { initialFocus: "last" }));
        const rootElement = container.querySelector('#rootElement');
        const buttons = rootElement.querySelectorAll('button');
