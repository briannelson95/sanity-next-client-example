...
export default function ReferenceSchemaStory() {
    ...
    const schemaDef = useMemo(() => ({ name: 'test', types: [authorTypeDef, testTypeDef] }), [authorTypeDef, testTypeDef]);
    ...
    return (React.createElement(Card, { height: "fill" },
        React.createElement(Flex, { height: "fill" },
            React.createElement(Card, { flex: 1, overflow: "auto", padding: 4 },
                React.createElement(Label, { size: 1 }, "Schema definitions"),
                React.createElement(Box, { paddingTop: 4 }),
                React.createElement(Code, { language: "json", size: 1 }, JSON.stringify(schemaDef.types, null, 2))),
            React.createElement(Card, { borderLeft: true, flex: 1, overflow: "auto", padding: 4 },
                React.createElement(Label, { size: 1 }, "Schema types"),
                React.createElement(Box, { paddingTop: 4 }),
                React.createElement(Code, { language: "json", size: 1 }, JSON.stringify([schemaTypeToJSON(schema.get('author')), schemaTypeToJSON(schema.get('test'))], null, 2))))));
}
...
//# sourceMappingURL=ReferenceSchemaStory.js.map