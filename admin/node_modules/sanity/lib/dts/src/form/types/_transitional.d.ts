 ...
 * @alpha
 */
export declare type RenderCustomMarkers = (markers: PortableTextMarker[]) => React.ReactNode;
/**
 ...
 * @alpha
 */
export declare type FormBuilderArrayFunctionComponent = React.ComponentType<FormArrayInputFunctionsProps<any, any>>;
/**
 * unstable
 * @alpha
 */
export declare type FormBuilderCustomMarkersComponent = React.ComponentType<{
 ...
 * @alpha
 */
export declare type FormBuilderMarkersComponent = React.ComponentType<{
    markers: PortableTextMarker[];
 ...
 * @alpha
 */
export declare type FormBuilderInputComponentMap = Record<string, {
...
//# sourceMappingURL=_transitional.d.ts.map