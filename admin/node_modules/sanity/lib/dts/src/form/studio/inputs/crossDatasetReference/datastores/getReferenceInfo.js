    ...
    referenceType) {
        return (doc._type
            ...
            : documentPreviewStore
                ...
                .pipe(map((docType) => ({ _id: doc._id, _type: docType })))).pipe(switchMap((resolvedDoc) => {
            ...
            const publishedPreview$ = documentPreviewStore
                .observePaths(doc, previewPaths, apiConfig)
                .pipe(map((result) => (result ? prepareForPreview(result, refSchemaType) : result)));
            return combineLatest([publishedPreview$]).pipe(map(([publishedPreview]) => {
                return {
...
//# sourceMappingURL=getReferenceInfo.js.map