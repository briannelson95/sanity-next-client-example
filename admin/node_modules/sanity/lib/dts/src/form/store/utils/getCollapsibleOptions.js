 ...
 */
export function getCollapsedWithDefaults(options = {}, level) {
    if (options?.collapsible === false || options?.collapsable === false) {
        return { collapsible: false, collapsed: false };
    }
    const collapsed = typeof options?.collapsed === 'boolean' ? options.collapsed : level >= AUTO_COLLAPSE_DEPTH;
...
//# sourceMappingURL=getCollapsibleOptions.js.map