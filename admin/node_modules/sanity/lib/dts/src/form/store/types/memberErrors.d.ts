 ...
 * This error may happen for objects if we encounter fields that are not declared in the schema
 */
export declare type MixedArray = {
    type: 'MIXED_ARRAY';
    schemaType: ArraySchemaType;
};
/**
...
export interface FieldError {
    ...
    key: string;
    fieldName: string;
    error: IncompatibleTypeError | TypeAnnotationMismatchError | MissingKeysError | DuplicateKeysError | UndeclaredMembersError | MixedArray;
}
...
//# sourceMappingURL=memberErrors.d.ts.map