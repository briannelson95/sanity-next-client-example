...
export declare type ReferenceSearchFunction = (query: string) => Observable<ReferenceSearchHit[]>;
...
export interface ReferenceInputProps<Value = Reference> extends ObjectInputProps<Value, ReferenceSchemaType> {
    suffix?: ReactNode;
    liveEdit?: boolean;
