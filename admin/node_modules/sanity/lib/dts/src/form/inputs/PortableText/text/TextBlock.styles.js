...
export const BlockActionsOuter = styled(Box) `
  ...
  position: relative;
`;
export const BlockActionsInner = styled(Flex)(({ theme }) => {
...
`;
export const ChangeIndicatorWrapper = styled.div(({ theme, $hasChanges }) => {
...
//# sourceMappingURL=TextBlock.styles.js.map