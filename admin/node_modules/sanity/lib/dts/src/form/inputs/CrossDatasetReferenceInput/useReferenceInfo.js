...
export function useReferenceInfo(doc, getReferenceInfo) {
    ...
    const referenceInfo = useMemoObservable(() => doc._id
        ? getReferenceInfo(doc).pipe(map((result) => ({
            isLoading: false,
            result,
            error: undefined,
            retry,
        ...
        : of(EMPTY_STATE), [retryAttempt, getReferenceInfo, doc?._id, doc?._type, retry], INITIAL_LOADING_STATE);
