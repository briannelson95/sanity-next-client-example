...
export class ToolCanvas extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            cropping: false,
    ...
    render() {
        ...
        return (React.createElement(RootContainer, null,
            React.createElement(CanvasContainer, { readOnly: readOnly, ref: this.setCanvas, onDrag: this.handleDrag, onDragStart: this.handleDragStart, onDragEnd: this.handleDragEnd, onMouseMove: this.handleMouseMove, onMouseOut: this.handleMouseOut, height: image.height * ratio, width: image.width * ratio })));
    }
}
...
//# sourceMappingURL=ToolCanvas.js.map