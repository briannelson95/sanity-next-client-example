...
export function ListCounterStory() {
    ...
    return (React.createElement(Flex, { paddingLeft: 6, paddingRight: 4, paddingY: [4, 5, 6] },
        React.createElement(Container, { width: 1 },
            React.createElement(EditableWrapper, { "data-debug": debug ? '' : undefined, space: space }, items.map((item, itemIndex) => (React.createElement(Block, { fontSize: fontSize, index: itemIndex, key: itemIndex, value: item })))))));
}
...
function Block(props) {
    ...
    return (React.createElement(BlockRoot, { "$level": value.level || 0, "data-level": value.level || 0, "data-list-item": value.listItem },
        React.createElement(Flex, { align: "flex-start" },
            React.createElement(Text, { as: "span", "data-prefix": "", size: fontSize }),
            React.createElement(Box, { as: "span", flex: 1 },
                React.createElement(Text, { as: "span", "data-text": "", size: fontSize },
                    "Block ",
                    React.createElement("code", null,
                        "#",
                        index),
                    value.level !== undefined && (React.createElement(React.Fragment, null,
                        ", Level ",
                        React.createElement("code", null,
                            "#",
                            value.level))))))));
}
//# sourceMappingURL=ListCounterStory.js.map