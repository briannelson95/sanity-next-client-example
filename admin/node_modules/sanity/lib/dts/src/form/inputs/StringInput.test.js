...
describe('StringInput', () => {
    it('renders input value', async () => {
        const { result } = await renderStringInput({
            render: (inputProps) => React.createElement(StringInput, { ...inputProps, value: "test" }),
            fieldDefinition: {
                type: 'string',
                name: 'string',
                title: 'String',
    ...
    it('emits `set` patch', async () => {
        const { onChange, result } = await renderStringInput({
            render: (inputProps) => React.createElement(StringInput, { ...inputProps, value: "tes" }),
            fieldDefinition: {
                type: 'string',
                name: 'string',
                title: 'String',
    ...
    it('emits `unset` patch', async () => {
        const { onChange, result } = await renderStringInput({
            render: (inputProps) => React.createElement(StringInput, { ...inputProps, value: "t" }),
            fieldDefinition: {
                type: 'string',
                name: 'string',
                title: 'String',
