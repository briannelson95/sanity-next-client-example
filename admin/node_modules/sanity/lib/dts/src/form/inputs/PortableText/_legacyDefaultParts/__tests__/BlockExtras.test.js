...
function renderCustomMarkers(markers) {
    return markers.map((marker, index) => {
        if (marker.type === 'customMarkerTest') {
            return (React.createElement("div", { key: `marker-${index}`, "data-testid": "custom-marker-test" }, "Marker!"));
        }
        return null;
    });
}
function renderBlockActions() {
    return React.createElement("div", { "data-testid": "block-action-test" }, "Action!");
}
...
//# sourceMappingURL=BlockExtras.test.js.map