...
export function useMemberValidation(member) {
    ...
    const validation = useMemo(() => member?.schemaType && _isBlockType(member?.schemaType)
        ? memberValidation
        : memberValidation.concat(childValidation), [childValidation, member, memberValidation]);
...
//# sourceMappingURL=useMemberValidation.js.map