...
export function ObjectEditModal(props) {
    ...
    const title = React.createElement(React.Fragment, null,
        "Edit ",
        memberItem.node.schemaType.title);
    ...
    if (modalType === 'popover') {
        return (React.createElement(PopoverEditDialog, { elementRef: memberItem.elementRef, onClose: handleClose, scrollElement: scrollElement, title: title }, props.children));
    }
    return (React.createElement(DefaultEditDialog, { title: title, onClose: handleClose }, props.children));
}
//# sourceMappingURL=ObjectEditModal.js.map