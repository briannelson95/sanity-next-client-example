...
export function EditObjectsStory() {
    ...
    if (!type) {
        return (React.createElement(Card, { height: "fill", overflow: "auto", tone: "critical" },
            React.createElement(Stack, { padding: 4, space: 4 },
                React.createElement(Text, { weight: "bold" }, "\"body\" type not found"),
                React.createElement(Code, { language: "json", size: 1 }, JSON.stringify({
                    schema: schema._original,
                    schemaErrors: schema._validation,
                }, null, 2)))));
    }
    return (React.createElement(PortalProvider, { __unstable_elements: { default: portal.element } }));
}
//# sourceMappingURL=EditObjectsStory.js.map