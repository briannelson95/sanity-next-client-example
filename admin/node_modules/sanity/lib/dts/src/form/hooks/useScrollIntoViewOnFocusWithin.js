...
const SCROLL_OPTIONS = { scrollMode: 'if-needed' };
/**
 ...
 */
export function useScrollIntoViewOnFocusWithin(elementRef, hasFocusWithin) {
    return useDidUpdate(hasFocusWithin, useCallback((hadFocus, hasFocus) => {
        if (elementRef.current && !hadFocus && hasFocus) {
            scrollIntoView(elementRef.current, SCROLL_OPTIONS);
        }
    }, [elementRef]));
}
//# sourceMappingURL=useScrollIntoViewOnFocusWithin.js.map