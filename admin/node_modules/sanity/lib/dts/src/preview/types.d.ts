...
export declare type Previewable = (SanityDocumentLike | Reference) & {
    /**
...
export interface ObservePathsFn {
    (value: Previewable, paths: (string | Path)[], apiConfig?: ApiConfig): Observable<PreviewValue | SanityDocumentLike | Reference | string | null>;
}
