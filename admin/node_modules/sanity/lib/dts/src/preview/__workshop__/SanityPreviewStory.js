...
export default function SanityPreviewStory() {
    ...
    return (React.createElement(Box, { padding: 4 },
        React.createElement(Container, { width: 1 },
            React.createElement(Card, { border: true, padding: 2, radius: 2, style: { lineHeight: 0 } },
                React.createElement(SanityPreview, { layout: layout, schemaType: schemaType, value: value })))));
}
//# sourceMappingURL=SanityPreviewStory.js.map