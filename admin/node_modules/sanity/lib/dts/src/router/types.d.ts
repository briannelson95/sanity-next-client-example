 ...
 * @public
 */
export declare type RouteChildren = RouterNode[] | ((state: RouterState) => Router | RouterNode | RouterNode[] | undefined | false);
/**
 * @public
 */
 ...
 * @public
 */
export declare type IntentParameters = Record<string, unknown> | [Record<string, unknown>, Record<string, unknown>];
/**
 * @public
 */
