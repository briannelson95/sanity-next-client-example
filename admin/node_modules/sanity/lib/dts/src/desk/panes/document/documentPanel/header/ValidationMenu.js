...
export function ValidationMenu(props) {
    ...
    if (!hasValidationMarkers)
        return null;
    return (React.createElement(MenuButton, { id: id || '', button: React.createElement(Button, { ...buttonProps, title: "Show validation issues", mode: "bleed", "data-testid": "validation-list-button" }), menu: React.createElement(Menu, { open: isOpen },
            React.createElement(ValidationList, { documentType: schemaType, validation: validation, onClose: handleClose, onFocus: onPathOpen })), popover: {
            portal: true,
...
//# sourceMappingURL=ValidationMenu.js.map