...
export function PopoverDialog(props) {
    ...
    return (React.createElement(Popover, { content: React.createElement(PopoverDialogContent, { modal: modal }), fallbackPlacements: POPOVER_FALLBACK_PLACEMENTS, open: true, placement: "top", portal: true, preventOverflow: true, referenceElement: referenceElement }));
}
function PopoverDialogContent(props) {
    ...
    return React.createElement("div", { ref: setElement }, content);
}
