    ...
    if (reason === 'ALREADY_PUBLISHED' && publishedAt) {
        return (React.createElement(React.Fragment, null,
            React.createElement("span", null,
                "Published ",
                React.createElement(TimeAgo, { time: publishedAt }))));
    }
...
export const PublishAction = (props) => {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
        return {
            tone: 'positive',
            label: 'Publish',
            title: (React.createElement(InsufficientPermissionsMessage, { operationLabel: "publish this document", currentUser: currentUser })),
            disabled: true,
        };
    }
    const disabled = Boolean(publishScheduled ||
