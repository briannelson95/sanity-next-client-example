...
export const HistoryRestoreAction = ({ id, type, revision, onComplete }) => {
    ...
    const modal = useMemo(() => {
        if (isConfirmDialogOpen) {
            return {
                ...
                message: React.createElement(React.Fragment, null, "Are you sure you want to restore this document?"),
            };
        }
        return null;
...
//# sourceMappingURL=HistoryRestoreAction.js.map