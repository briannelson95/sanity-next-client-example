 ...
 */
export declare function createResolvedPaneNodeStream({ routerPanesStream, rootPaneNode, initialCacheState, structureContext, }: CreateResolvedPaneNodeStreamOptions): Observable<ResolvedPaneMeta[]>;
export {};
