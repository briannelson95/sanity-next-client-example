...
export const Pane = forwardRef(function Pane(props, ref) {
    ...
    const divider = useMemo(() => !isLast &&
        !layoutCollapsed && (React.createElement(LegacyLayerProvider, { zOffset: "paneResizer" },
        React.createElement(PaneDivider, { disabled: collapsed || nextCollapsed, element: rootElement }))), [collapsed, isLast, layoutCollapsed, nextCollapsed, rootElement]);
    const style = useMemo(() => ({
        flex,
        minWidth,
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(LegacyLayerProvider, { zOffset: "pane" },
            React.createElement(PaneContext.Provider, { value: contextValue },
                React.createElement(Root, { "data-testid": "pane", tone: "inherit", hidden: hidden, id: id, overflow: layoutCollapsed ? undefined : 'hidden', ...restProps, "data-pane-collapsed": collapsed ? '' : undefined, "data-pane-index": paneIndex, "data-pane-selected": selected ? '' : undefined, ref: setRef, style: style },
                    PANE_DEBUG && (React.createElement(Card, { padding: 4, tone: expanded ? 'primary' : 'caution' },
                    ...
                    React.createElement(BoundaryElementProvider, { element: rootElement }, !hidden && (React.createElement(Flex, { direction: "column", height: "fill" }, children)))))),
        divider));
});
