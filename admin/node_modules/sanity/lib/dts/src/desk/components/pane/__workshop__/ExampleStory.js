...
export default function ExampleStory() {
    ...
    const actions = useMemo(() => React.createElement(Button, { icon: EllipsisVerticalIcon, mode: "bleed" }), []);
    const tabs = useMemo(() => manyTabs ? (React.createElement(TabList, { space: 1 },
        React.createElement(Tab, { "aria-controls": "content-panel", fontSize: 1, id: "content-tab", label: "Content", selected: true }),
        React.createElement(Tab, { "aria-controls": "preview-panel", fontSize: 1, id: "preview-tab", label: "Preview" }),
        React.createElement(Tab, { "aria-controls": "preview-panel", fontSize: 1, id: "preview-tab", label: "Preview" }),
        React.createElement(Tab, { "aria-controls": "preview-panel", fontSize: 1, id: "preview-tab", label: "Preview" }),
        React.createElement(Tab, { "aria-controls": "preview-panel", fontSize: 1, id: "preview-tab", label: "Preview" }),
        React.createElement(Tab, { "aria-controls": "preview-panel", fontSize: 1, id: "preview-tab", label: "Preview" }),
            ...
            React.createElement(PaneContent, { overflow: "auto" },
                React.createElement(Container, { paddingX: 4, paddingY: [4, 4, 5], sizing: "border", width: 1 },
                    React.createElement(Stack, { space: 4 },
                        ...
                        React.createElement(Text, { muted: true }, "Content"),
                        React.createElement(Text, { muted: true }, "Content")))),
            React.createElement(PaneFooter, { padding: 4 },
                React.createElement(Text, { muted: true }, "Footer")))));
}
//# sourceMappingURL=ExampleStory.js.map