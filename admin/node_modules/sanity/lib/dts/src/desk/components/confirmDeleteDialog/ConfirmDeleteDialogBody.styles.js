...
export const OtherReferenceCount = (props) => {
    ...
    return (React.createElement(Inline, { space: 2 },
        React.createElement(Text, { size: 1, muted: true },
            ...
            " not shown",
            ' '),
        React.createElement(Tooltip, { portal: true, placement: "top", content: React.createElement(Container, { width: 0 },
                React.createElement(Box, { padding: 2 },
                    React.createElement(Text, { size: 1 }, "We can't show metadata about these references because no token with access to the datasets they are in was found."))) },
            React.createElement(Text, { size: 1, muted: true },
                React.createElement(InfoOutlineIcon, null)))));
};
//# sourceMappingURL=ConfirmDeleteDialogBody.styles.js.map