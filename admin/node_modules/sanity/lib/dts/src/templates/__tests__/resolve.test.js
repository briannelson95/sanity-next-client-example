...
describe('resolveInitialValue', () => {
    ...
    test('throws on missing template `value` prop', () => {
        expect(resolveInitialValue(schema, omit(example, ['value']))).rejects.toMatchObject({
    ...
    test('should call sync value resolvers', () => {
        expect(resolveInitialValue(schema, { ...example, value: () => example.value })).resolves.toMatchObject({
            title: 'here',
        });
    });
