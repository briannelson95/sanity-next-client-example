 ...
 */
export function createDefaultIcon(title, subtitle) {
    ...
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32" },
        React.createElement("rect", { width: 32, height: 32, rx: 2, fill: color }),
        React.createElement(SvgText, { x: "50%", y: "50%", textAnchor: "middle", alignmentBaseline: "middle", dominantBaseline: "middle", fill: textColor }, letters)));
}
