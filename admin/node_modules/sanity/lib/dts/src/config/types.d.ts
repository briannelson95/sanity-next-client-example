...
import type { Schema, SchemaType, AssetSource, CurrentUser, SanityDocumentLike, SchemaTypeDefinition, ObjectSchemaType } from '@sanity/types';
import type React from 'react';
import type { Observable } from 'rxjs';
import type { BifurClient } from '@sanity/bifur-client';
import { ComponentType, ReactNode } from 'react';
import type { FormBuilderArrayFunctionComponent, FormBuilderCustomMarkersComponent, FormBuilderMarkersComponent, InputProps, FieldProps, ItemProps, RenderFieldCallback, RenderInputCallback, RenderItemCallback, RenderPreviewCallback } from '../form';
...
export interface SchemaPluginOptions {
    name?: string;
    types?: SchemaTypeDefinition[] | ComposableOption<SchemaTypeDefinition[], Omit<ConfigContext, 'schema' | 'currentUser' | 'client'>>;
