...
export default function ChangelogDialogStory() {
    ...
    return (React.createElement(ChangelogDialog, { changelog: changelog, currentVersion: currentVersion, latestVersion: latestVersion }));
}
const changelog = [
    {
        version: '3.0.0',
...
//# sourceMappingURL=ChangelogDialogStory.js.map