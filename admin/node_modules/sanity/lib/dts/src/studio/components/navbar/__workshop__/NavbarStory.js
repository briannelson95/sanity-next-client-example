...
const SearchFullscreenPortalCard = styled(Card) `
  ...
  flex: 1;
`;
const ExampleTool = () => React.createElement("div", null, "Tool");
const noop = () => null;
...
export default function NavbarStory() {
    ...
    return (React.createElement(StudioProvider, { config: config },
        React.createElement(Navbar, { onSearchOpenChange: noop, fullscreenSearchPortalEl: portalEl }),
        React.createElement(SearchFullscreenPortalCard, { ref: setPortalEl })));
}
function useTools() {
    const toggledTools = {
