...
export default function ChangeListStory() {
    ...
    const FieldWrapper = useCallback((_props) => {
        ...
        return React.createElement(Card, null, _props.children);
    }, []);
    ...
    return (React.createElement(Card, { height: "fill", padding: [4, 5, 6, 7], sizing: "border", tone: "transparent" },
        React.createElement(Container, { width: 1 },
            React.createElement(Card, { padding: 4, radius: 3 },
                React.createElement(DocumentChangeContext.Provider, { value: documentContext },
                    React.createElement(ChangeList, { diff: diff, schemaType: schemaType }))))));
}
//# sourceMappingURL=ChangeListStory.js.map