...
import { DiffComponent, DiffComponentOptions, ObjectDiff } from '../../../types';
...
export declare function isPTSchemaType(schemaType: SchemaType): schemaType is BlockSchemaType;
...
export declare function getChildSchemaType(fields: ObjectField<SchemaType>[], child: PortableTextChild): ObjectSchemaType | undefined;
