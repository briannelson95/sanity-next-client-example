import React from 'react'; // const Root = styled(Card).attrs({height: 'fill', overflow: 'auto'})``
...
export function ConfigErrorsScreen() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, "TODO: implement config errors screen"); // return (
