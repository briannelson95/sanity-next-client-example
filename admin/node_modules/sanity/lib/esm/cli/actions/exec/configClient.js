...
import { getCliClient } from '../../../_exports/cli'; // eslint-disable-next-line no-process-env

const sanityEnv = (process.env.SANITY_INTERNAL_ENV || '').toLowerCase();
const defaults = {};
const config = new ConfigStore(sanityEnv && sanityEnv !== 'production' ? "sanity-".concat(sanityEnv) : 'sanity', defaults, {
