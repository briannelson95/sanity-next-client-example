...
const GithubRoot = styled.svg(_ref => {
  let {
    theme
  } = _ref;
  const {
...
const GithubLogo = () => /*#__PURE__*/React.createElement(GithubRoot // data-sanity-icon="google-logo"
, {
  width: "1em",
  height: "1em",
...
const GoogleLogo = () => /*#__PURE__*/React.createElement("svg", {
...
function CustomLogo(props) {
  ...
  return provider.logo ? /*#__PURE__*/React.createElement("img", {
    src: provider.logo,
