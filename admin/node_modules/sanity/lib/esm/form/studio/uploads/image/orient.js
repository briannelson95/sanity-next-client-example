...
function rotate(ctx, options) {
  ...
  ctx === null || ctx === void 0 ? void 0 : ctx.translate(x, y);
  ctx === null || ctx === void 0 ? void 0 : ctx.rotate(radians);
  ctx === null || ctx === void 0 ? void 0 : ctx.translate(-x, -y);
...
function flip(canvas, x, y) {
  ...
  ctx === null || ctx === void 0 ? void 0 : ctx.translate(x ? canvas.width : 0, y ? canvas.height : 0);
  ctx === null || ctx === void 0 ? void 0 : ctx.scale(x ? -1 : 1, y ? -1 : 1);
}
...
export const DEFAULT_ORIENTATION = 'top-left';
...
function _orient(img, orientationNumber) {
  ...
  if (orientation.degrees) {
    ...
    if (rotated(orientationNumber)) {
      ...
      ctx === null || ctx === void 0 ? void 0 : ctx.translate(d / 2, -d / 2);
    }
  }
...
export function orient(image, orientationId) {
