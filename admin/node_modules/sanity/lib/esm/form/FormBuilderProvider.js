...
export function FormBuilderProvider(props) {
  ...
  const __internal = useMemo(() => ({
    ...
    components: {
      ArrayFunctions: (unstable === null || unstable === void 0 ? void 0 : unstable.ArrayFunctions) || DefaultArrayInputFunctions,
      CustomMarkers: (unstable === null || unstable === void 0 ? void 0 : unstable.CustomMarkers) || DefaultCustomMarkers,
      Markers: (unstable === null || unstable === void 0 ? void 0 : unstable.Markers) || DefaultMarkers
    },
    file: {
      assetSources: file !== null && file !== void 0 && file.assetSources ? _ensureArrayOfSources(file.assetSources) || defaultFileAssetSources : defaultFileAssetSources,
      directUploads: (file === null || file === void 0 ? void 0 : file.directUploads) !== false
    },
    filterField: filterField || (() => true),
    image: {
      assetSources: image !== null && image !== void 0 && image.assetSources ? _ensureArrayOfSources(image.assetSources) || defaultImageAssetSources : defaultImageAssetSources,
  ...
  return /*#__PURE__*/React.createElement(FormBuilderContext.Provider, {
    value: formBuilder
  }, /*#__PURE__*/React.createElement(FormCallbacksProvider, {
    onChange: onChange,
  ...
  }, /*#__PURE__*/React.createElement(PresenceProvider, {
    presence: presence
