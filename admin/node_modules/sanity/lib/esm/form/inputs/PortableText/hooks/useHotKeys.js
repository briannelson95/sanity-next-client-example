...
import { PortableTextEditor, usePortableTextEditor } from '@sanity/portable-text-editor'; // This hook will create final hotkeys for the editor from on those from props.

export function useHotkeys(hotkeys) {
  const editor = usePortableTextEditor(); // Guard that hotkeys from props will be a stable object.
  ...
  return useMemo(() => {
    ...
    return {
      marks: { ...defaultHotkeys.marks,
        ...(initialHotkeys || {}).marks
      },
