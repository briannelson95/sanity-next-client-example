...
export function useScrollToOpenedMember(props) {
  const {
    editorRootPath,
    scrollElement,
    hasFocus,
  ...
  const editor = usePortableTextEditor(); // Find the opened item with the highest path
  ...
  useEffect(() => {
    ...
    if (memberItem !== null && memberItem !== void 0 && (_memberItem$elementRe = memberItem.elementRef) !== null && _memberItem$elementRe !== void 0 && _memberItem$elementRe.current) {
      ...
      scrollIntoView((_memberItem$elementRe2 = memberItem.elementRef) === null || _memberItem$elementRe2 === void 0 ? void 0 : _memberItem$elementRe2.current, {
      ...
      if (memberItem.kind === 'textBlock') {
        ...
        PortableTextEditor.focus(editor); // "auto-close" regular text blocks or they get sticky here when trying to focus on an other field
