import { isKeyedObject, isKeySegment } from '@sanity/types'; // Tests whether a keyed value matches a given keyed pathSegment
...
export function hasFocusAtPath(path, value) {
