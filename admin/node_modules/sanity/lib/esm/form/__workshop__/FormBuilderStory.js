...
export default function FormBuilderStory() {
  ...
  const presence = useMemo(() => [], []); // Create a patch channel
  ...
  if (!schemaType) {
    return /*#__PURE__*/React.createElement("div", null, "Schema type not found: ", /*#__PURE__*/React.createElement(React.Fragment, null, documentType));
  }
