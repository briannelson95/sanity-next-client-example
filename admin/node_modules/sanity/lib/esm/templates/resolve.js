import { // InitialValueParams,
isArraySchemaType, isObjectSchemaType } from '@sanity/types';
...
export async function resolveValue(initialValueOpt, params) {
...
export async function resolveInitialValue(schema, template) {
  ...
  const newValue = deepAssign((await resolveInitialValueForType(schemaType, params)) || {}, resolvedValue); // revalidate and return new initial values
...
export async function resolveInitialObjectValue(type, params, maxDepth) {
