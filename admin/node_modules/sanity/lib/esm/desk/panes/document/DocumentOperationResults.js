...
export const DocumentOperationResults = /*#__PURE__*/memo(function DocumentOperationResults() {
  const {
    push: pushToast
  } = useToast();
  const {
  ...
  useEffect(() => {
    ...
    if (event.type === 'error') {
      pushToast({
        ...
        description: /*#__PURE__*/React.createElement("details", null, /*#__PURE__*/React.createElement("summary", null, "Details"), event.error.message)
      });
    }
