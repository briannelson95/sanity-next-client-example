...
function getDisabledReason(reason, publishedAt) {
  if (reason === 'ALREADY_PUBLISHED' && publishedAt) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null, "Published ", /*#__PURE__*/React.createElement(TimeAgo, {
      time: publishedAt
    })));
  }
...
export const PublishAction = props => {
  ...
  const hasValidationErrors = validationStatus.validation.some(isValidationErrorMarker); // we use this to "schedule" publish after pending tasks (e.g. validation and sync) has completed
  ...
  const currentUser = useCurrentUser(); // eslint-disable-next-line no-nested-ternary
