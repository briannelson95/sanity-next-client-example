...
function validatePlugin(pluginResult) {
  ...
  const messages = ['projectId' in pluginResult && '`projectId` not allowed in plugin configuration', 'dataset' in pluginResult && '`dataset` not allowed in plugin configuration'].filter(_isString);
