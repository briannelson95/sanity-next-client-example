...
export const initialDocumentActions = [PublishAction, DiscardChangesAction, UnpublishAction, DuplicateAction, DeleteAction];
export const initialLanguageFilter = [];
export const schemaTypesReducer = (prev, _ref, context) => {
  let {
    schema
  } = _ref;
...
export const resolveProductionUrlReducer = async (prev, _ref2, context) => {
  let {
    document
  } = _ref2;
...
export const toolsReducer = (prev, _ref3, context) => {
  let {
    tools
  } = _ref3;
...
export const schemaTemplatesReducer = (prev, _ref4, context) => {
  let {
    schema
  } = _ref4;
...
export const documentBadgesReducer = (prev, _ref5, context) => {
  let {
    document
  } = _ref5;
...
export const documentActionsReducer = (prev, _ref6, context) => {
  let {
    document
  } = _ref6;
...
export const newDocumentOptionsResolver = (prev, _ref7, context) => {
  let {
    document
  } = _ref7;
...
export const fileAssetSourceResolver = (prev, _ref8, context) => {
  var _form$file;
...
export const imageAssetSourceResolver = (prev, _ref9, context) => {
  var _form$image;
...
export const _documentLanguageFilterReducer = (prev, _ref10, context) => {
  let {
    document
  } = _ref10;
