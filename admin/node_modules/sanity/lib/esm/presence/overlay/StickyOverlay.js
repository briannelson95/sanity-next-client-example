...
const orderByTop = regionsWithIntersectionDetails => _orderBy(regionsWithIntersectionDetails, withIntersection => withIntersection.region.rect.top);
...
function group(regionsWithIntersectionDetails) {
  ...
  const grouped = {
    ...
    inside: [],
    bottom: [],
    ..._groupBy(regionsWithSpacerHeight, _withSpacerHeight => _withSpacerHeight.position)
  };
  return {
...
export function StickyOverlay(props) {
  ...
  const renderCallback = React.useCallback((regionsWithIntersectionDetails, containerWidth) => {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PresenceDock, {
      ...
      height: topSpacing
    }), /*#__PURE__*/React.createElement(PresenceInside, {
      containerWidth: containerWidth,
      regionsWithIntersectionDetails: grouped.inside
    }), /*#__PURE__*/React.createElement(Spacer, {
      height: bottomSpacing
    }), /*#__PURE__*/React.createElement(PresenceDock, {
  ...
  return /*#__PURE__*/React.createElement(RegionsWithIntersections, {
    ref: ref,
    margins: margins,
    regions: regions,
...
const EMPTY_ARRAY = [];
const PresenceDock = /*#__PURE__*/memo(function PresenceDock(props) {
  const {
    closeCount,
    margins,
    position,
  ...
  const allPresenceItems = useMemo(() => {
    ...
    return _flatten(_sortBy(regionsWithIntersectionDetails, r => r.region.rect.top * dir).map(withIntersection => withIntersection.region.presence || EMPTY_ARRAY));
  }, [dir, regionsWithIntersectionDetails]);
  const [topMargin, rightMargin, bottomMargin, leftMargin] = margins;
  const leftOffset = (leftMargin || 0) + (allPresenceItems.length > 0 ? -closeCount * (AVATAR_SIZE + AVATAR_DISTANCE) : 0) - rightMargin;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: style
  }, /*#__PURE__*/React.createElement(FieldPresenceInner, {
    position: position,
...
function PresenceInside(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, regionsWithIntersectionDetails.map(withIntersection => {
...
const DebugValue = DEBUG ? function DebugValue(props) {
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute'
    }
