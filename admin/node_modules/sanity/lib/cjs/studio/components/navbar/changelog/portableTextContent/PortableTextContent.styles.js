...
const SpaceBox = (0, _styledComponents.default)(_ui.Box)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  ", ";\n"])), _listStyles.listStyles);
exports.SpaceBox = SpaceBox;
const RootBox = (0, _styledComponents.default)(_ui.Box)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  ", ":first-child {\n    &:not([data-list-type='number'], [data-list-type='bullet']) {\n      margin-top: 0;\n    }\n  }\n\n  ", ":last-child {\n    margin-bottom: 0;\n  }\n"])), SpaceBox, SpaceBox);
exports.RootBox = RootBox;
const ListBoxOuter = (0, _styledComponents.default)(_ui.Box)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  line-height: 1;\n"])));
exports.ListBoxOuter = ListBoxOuter;
const ListBox = (0, _styledComponents.default)(_ui.Box)(() => {
...
const ImageCard = (0, _styledComponents.default)(_ui.Card)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  position: relative;\n  padding-bottom: ", "%;\n  background-image: ", ";\n  background-size: cover;\n\n  img {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    object-fit: cover;\n  }\n"])), _ref => {
  let {
    $aspectRatio
  } = _ref;
  return $aspectRatio;
