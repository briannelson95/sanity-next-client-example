...
function ChangelogDialogStory() {
  const currentVersion = (0, _uiWorkshop.useString)('Current version', '2.9.0');
  const latestVersion = (0, _uiWorkshop.useString)('Latest version', '3.0.0');
  return /*#__PURE__*/_react.default.createElement(_changelog.ChangelogDialog, {
    changelog: changelog,
