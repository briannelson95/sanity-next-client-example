...
const StickyBox = (0, _styledComponents.default)(_ui.Box)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: sticky;\n  top: 0;\n  z-index: 1;\n"])));
const EMPTY_ARRAY = [];
...
function ChangelogDialog(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Dialog, _extends({
    ...
    weight: "semibold"
  }, "Changelog"), currentVersion && latestVersion && /*#__PURE__*/_react.default.createElement(_ui.Text, {
    muted: true,
    size: 1
