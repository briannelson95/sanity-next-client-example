...
exports.PresenceMenuItem = void 0;
...
const AvatarCard = (0, _styledComponents.default)(_ui.Card)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background: transparent;\n  margin: calc((-35px + 11px) / 2);\n"])));
const PresenceMenuItem = /*#__PURE__*/(0, _react.memo)(function PresenceMenuItem(_ref) {
  let {
    presence
  } = _ref;
  const lastActiveLocation = (0, _orderBy2.default)(presence.locations || [], ['lastActiveAt'], ['desc']).find(location => location.documentId);
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.MenuItem, {
    ...
    align: "center"
  }, /*#__PURE__*/_react.default.createElement(AvatarCard, null, /*#__PURE__*/_react.default.createElement(_UserAvatar.UserAvatar, {
    size: 1,
