...
function DiffFromTo(props) {
  ...
  const changeVerb = (0, _helpers.getChangeVerb)(diff);
  ...
  const from = diff.fromValue !== undefined && diff.fromValue !== null && /*#__PURE__*/_react.default.createElement(_DiffCard.DiffCard, {
    as: "del",
    className: cardClassName,
    diff: diff,
    path: path,
  ...
  const to = diff.toValue !== undefined && diff.toValue !== null && /*#__PURE__*/_react.default.createElement(_DiffCard.DiffCard, {
    as: "ins",
    className: cardClassName,
    diff: diff,
    path: path,
