...
function PermissionCheckBanner(_ref) {
  ...
  const roles = join((currentUser === null || currentUser === void 0 ? void 0 : (_currentUser$roles2 = currentUser.roles) === null || _currentUser$roles2 === void 0 ? void 0 : _currentUser$roles2.map(r => /*#__PURE__*/_react.default.createElement("code", {
    key: r.name
  }, r.title))) || [], ', ');
