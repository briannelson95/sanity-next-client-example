...
const DocumentOperationResults = /*#__PURE__*/(0, _react.memo)(function DocumentOperationResults() {
  const {
    push: pushToast
  } = (0, _ui.useToast)();
  const {
  ...
  const event = (0, _hooks.useDocumentOperationEvent)(documentId, documentType);
  (0, _react.useEffect)(() => {
    if (!event) return;
