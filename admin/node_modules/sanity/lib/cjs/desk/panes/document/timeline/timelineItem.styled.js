...
const IconWrapper = (0, _styledComponents.default)(_ui.Flex)(_ref => {
...
const Root = (0, _styledComponents.default)(_ui.MenuItem)(_ref2 => {
  let {
    state = 'enabled',
    isHovered,
    theme
...
exports.Root = Root;
const IconBox = (0, _styledComponents.default)(_ui.Box)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  background: var(--card-bg-color);\n  border-radius: 50px;\n  position: relative;\n  z-index: 2;\n"])));
exports.IconBox = IconBox;
const EventLabel = (0, _styledComponents.default)(_ui.Text)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  text-transform: capitalize;\n"])));
