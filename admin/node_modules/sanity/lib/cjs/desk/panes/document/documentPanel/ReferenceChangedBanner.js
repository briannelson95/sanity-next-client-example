...
const TextOneLine = (0, _styledComponents.default)(_ui.Text)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  & > * {\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
const ReferenceChangedBanner = /*#__PURE__*/(0, _react.memo)(() => {
  ...
  const parentRefPath = (0, _react.useMemo)(() => {
  ...
  const referenceInfo = (0, _reactRx.useMemoObservable)(() => {
    ...
    const publishedId = (0, _util.getPublishedId)(parentId);
    const path = (0, _paths.fromString)(parentRefPathSegment); // note: observePaths doesn't support keyed path segments, so we need to select the nearest parent
  ...
  const handleReloadReference = (0, _react.useCallback)(() => {
