...
const ReviewButton = /*#__PURE__*/_react.default.forwardRef(function ReviewButton(props, ref) {
  const {
    collapsed,
    status,
    lastUpdated,
  ...
  const lastUpdatedTime = (0, _hooks.useTimeAgo)(lastUpdated || '', {
    minimal: true
  });
  const lastUpdatedTimeAgo = (0, _hooks.useTimeAgo)(lastUpdated || '', {
    minimal: true,
    agoSuffix: true
  });
...
const ReviewChangesButton = /*#__PURE__*/_react.default.memo(ReviewButton);
