...
function createPaneLayoutController() {
  ...
  function resize(type, leftElement, deltaX) {
    ...
    if (type === 'move' && cache.left && cache.right) {
      ...
      const {
        ...
        leftFlex,
        rightFlex
      } = (0, _helpers._calcPaneResize)(cache, leftOptions, rightOptions, deltaX); // update resize cache
  ...
  function _notifyObservers() {
    ...
    const collapsedWidth = (len - 1) * _constants.PANE_COLLAPSED_WIDTH;
    ...
    for (const element of _elements) {
      ...
      const minWidth = options.currentMinWidth || options.minWidth || _constants.PANE_DEFAULT_MIN_WIDTH;
