...
function ExampleStory() {
  const layoutCollapsed = (0, _uiWorkshop.useBoolean)('Layout collapsed', false, 'Props');
  const manyTabs = (0, _uiWorkshop.useBoolean)('Many tabs', false, 'Props');
  const tone = (0, _uiWorkshop.useSelect)('Tone', PANE_TONE_OPTIONS, 'default', 'Props');
  const actions = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_ui.Button, {
    icon: _icons.EllipsisVerticalIcon,
    mode: "bleed"
  }), []);
  const tabs = (0, _react.useMemo)(() => manyTabs ? /*#__PURE__*/_react.default.createElement(_ui.TabList, {
    space: 1
