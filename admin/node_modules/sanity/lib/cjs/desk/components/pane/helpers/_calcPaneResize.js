...
function _calcPaneResize(cache, left, right, deltaX) {
  ...
  const leftMinWidth = (_left$minWidth = left.minWidth) !== null && _left$minWidth !== void 0 ? _left$minWidth : _constants.PANE_DEFAULT_MIN_WIDTH;
  const rightMinWidth = (_right$minWidth = right.minWidth) !== null && _right$minWidth !== void 0 ? _right$minWidth : _constants.PANE_DEFAULT_MIN_WIDTH;
