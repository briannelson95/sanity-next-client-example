 ...
 * @internal
 */
const BackLink = /*#__PURE__*/(0, _react.forwardRef)(function BackLink(props, ref) {
  const {
    routerPanesState,
    groupIndex
  } = (0, _react.useContext)(_PaneRouterContext.PaneRouterContext);
  const panes = (0, _react.useMemo)(() => routerPanesState.slice(0, groupIndex), [groupIndex, routerPanesState]);
