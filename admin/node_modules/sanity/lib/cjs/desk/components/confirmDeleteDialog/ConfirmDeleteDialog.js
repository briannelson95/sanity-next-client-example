...
const DialogBody = (0, _styledComponents.default)(_ui.Flex).attrs({
  padding: 4,
  direction: 'column',
  height: 'fill'
})(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n"])));
exports.DialogBody = DialogBody;
const LoadingContainer = (0, _styledComponents.default)(_ui.Flex).attrs({
  align: 'center',
  direction: 'column',
  justify: 'center'
...
function ConfirmDeleteDialog(_ref) {
  ...
  const dialogId = "deletion-confirmation-".concat((0, _autoId.useId)());
  const {
    internalReferences,
    ...
    totalCount,
    projectIds
  } = (0, _useReferringDocuments.useReferringDocuments)(id);
  const capitalizedAction = "".concat(action.substring(0, 1).toUpperCase()).concat(action.substring(1));

  const documentTitle = /*#__PURE__*/_react.default.createElement(_DocTitle.DocTitle, {
