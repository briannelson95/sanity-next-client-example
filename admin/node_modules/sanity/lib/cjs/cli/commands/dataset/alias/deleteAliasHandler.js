...
exports.deleteAliasHandler = void 0;
...
const deleteAliasHandler = async (args, context) => {
  ...
  const dsError = (0, _validateDatasetAliasName.validateDatasetAliasName)(aliasName);
...
exports.deleteAliasHandler = deleteAliasHandler;