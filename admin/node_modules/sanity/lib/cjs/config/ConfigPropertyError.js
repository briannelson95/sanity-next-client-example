...
exports.ConfigPropertyError = void 0;
...
class ConfigPropertyError extends Error {
  constructor(_ref) {
    ...
    const message = (0, _util.isRecord)(cause) && typeof (cause === null || cause === void 0 ? void 0 : cause.message) === 'string' ? ": ".concat(cause.message) : '';
