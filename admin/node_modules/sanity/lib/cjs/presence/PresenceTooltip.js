...
function PresenceTooltip(props) {
  ...
  const content = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_ui.Stack, {
    padding: 1
  }, items.map(item => /*#__PURE__*/_react.default.createElement(_ui.Flex, {
    align: "center",
    gap: 2,
    padding: 1,
    key: item.user.id
