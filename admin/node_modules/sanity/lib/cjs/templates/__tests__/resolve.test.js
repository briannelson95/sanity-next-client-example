...
describe('resolveInitialValue', () => {
  test('serializes builders', () => {
    expect((0, _.resolveInitialValue)(_schema.schema, example)).resolves.toMatchObject({
      title: 'here'
    });
  });
  ...
  test('throws on missing template `value` prop', () => {
    expect((0, _.resolveInitialValue)(_schema.schema, (0, _omit2.default)(example, ['value']))).rejects.toMatchObject({
