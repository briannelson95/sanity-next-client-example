...
function CalendarMonth(props) {
  return /*#__PURE__*/_react.default.createElement(_ui.Box, {
    ...
    const focused = props.focused && (0, _dateFns.isSameDay)(date, props.focused);
    const selected = props.selected && (0, _dateFns.isSameDay)(date, props.selected);
    const isToday = (0, _dateFns.isSameDay)(date, new Date());
    const isCurrentMonth = props.focused && (0, _dateFns.isSameMonth)(date, props.focused);
