...
function getPTEFormatActions(editor, disabled, hotkeyOpts) {
  const features = _portableTextEditor.PortableTextEditor.getPortableTextFeatures(editor);
...
function getPTEAnnotationActions(editor, disabled, onInsert) {
  ...
  const focusChild = _portableTextEditor.PortableTextEditor.focusChild(editor);
...
function getInsertMenuIcon(type, fallbackIcon) {
  const referenceIcon = (0, _get2.default)(type, 'to[0].icon');
