...
var _inputResolver = require("../../../../studio/inputResolver/inputResolver");
...
const DebugInput = /*#__PURE__*/(0, _react.forwardRef)(function DebugInput(props, ref) {
...
function inputResolver(input, form) {
  if (!input.type) {
  ...
  return (0, _inputResolver.defaultResolveInputComponent)(input.type) || DebugInput;
}