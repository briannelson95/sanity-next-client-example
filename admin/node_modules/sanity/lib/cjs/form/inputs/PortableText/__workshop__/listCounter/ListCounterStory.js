...
function ListCounterStory() {
  const debug = (0, _uiWorkshop.useBoolean)('Debug', false);
  const fontSize = (0, _uiWorkshop.useSelect)('Font size', FONT_SIZE_OPTIONS, 2);
  const space = (0, _uiWorkshop.useSelect)('Space', SPACE_OPTIONS, 3);
...
const BlockRoot = _styledComponents.default.div(props => {
  const {
    $level
  } = props;
