...
function ArrayOfPrimitivesFunctions(props) {
  const {
    type,
    readOnly,
    children,
  ...
  const menuButtonId = (0, _autoId.useId)();

  const insertItem = _react.default.useCallback(itemType => {
    onAppendItem(onCreateValue(itemType));
  }, [onCreateValue, onAppendItem]);

  const handleAddBtnClick = _react.default.useCallback(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Grid, {
    ...
    menu: /*#__PURE__*/_react.default.createElement(_ui.Menu, null, type.of.map((memberDef, i) => {
      ...
      const referenceIcon = (0, _types.isReferenceSchemaType)(memberDef) && (memberDef.to || []).length === 1 && memberDef.to[0].icon;
