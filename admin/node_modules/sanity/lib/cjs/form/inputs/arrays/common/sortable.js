...
const MOVING_ITEM_CLASS_NAME = 'moving';
exports.MOVING_ITEM_CLASS_NAME = MOVING_ITEM_CLASS_NAME;
const DRAG_HANDLE_ATTRIBUTE = 'data-drag-handle'; // higher order components to make a sortable list/item components
...
function sortableContainer(Component, options) {
  const Container = (0, _reactSortableHoc.SortableContainer)( /*#__PURE__*/_react.default.forwardRef(function Sortable(props, forwardedRef) {
