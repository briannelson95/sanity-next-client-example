...
const Root = _styledComponents.default.legend(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  /* See: https://thatemil.com/blog/2015/01/03/reset-your-fieldset/ */\n  padding: 0;\n  display: table;\n"])));

const ToggleButton = (0, _styledComponents.default)(_ui.Flex).attrs({
  forwardedAs: 'button'
})(props => {
  const {
    theme
...
const ToggleIconBox = (0, _styledComponents.default)(_ui.Box)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  width: 9px;\n  height: 9px;\n  margin-right: 3px;\n\n  & svg {\n    transition: transform 100ms;\n  }\n"])));
const FormFieldSetLegend = /*#__PURE__*/(0, _react.memo)(function FormFieldSetLegend(props) {
  const {
    collapsed,
    collapsible,
    onClick,
  ...
  const text = /*#__PURE__*/_react.default.createElement(_ui.Text, {
    weight: "semibold",
    size: 1
