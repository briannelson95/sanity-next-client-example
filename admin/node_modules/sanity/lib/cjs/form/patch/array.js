...
exports._arrayApply = _arrayApply;
...
function _arrayApply(value, patch) {
  ...
  if (tail.length === 0) {
    if (patch.type === 'insert') {
      ...
      return (0, _arrayInsert.arrayInsert)(value, position, index, items);
    } else if (patch.type === 'unset') {
  ...
  nextValue[index] = (0, _applyPatch.applyPatch)(nextValue[index], { ...patch,
    path: tail
  });
  return nextValue;
}