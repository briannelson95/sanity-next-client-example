...
const GithubRoot = _styledComponents.default.svg(_ref => {
  let {
    theme
  } = _ref;
  const {
...
const GithubLogo = () => /*#__PURE__*/_react.default.createElement(GithubRoot // data-sanity-icon="google-logo"
, {
  width: "1em",
  height: "1em",
...
const GoogleLogo = () => /*#__PURE__*/_react.default.createElement("svg", {
...
const providerLogos = {
  google: GoogleLogo,
  github: GithubLogo,
  custom: CustomLogo // sanity: () => <SanityMonogram data-sanity-icon="" />,

};
exports.providerLogos = providerLogos;