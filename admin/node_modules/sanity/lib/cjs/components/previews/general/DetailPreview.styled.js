...
const RootFlex = (0, _styledComponents.default)(_ui.Flex).attrs({
  align: 'center'
})(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  height: ", ";\n"])), (0, _ui.rem)(_constants.PREVIEW_MEDIA_SIZE.detail.height));
exports.RootFlex = RootFlex;
const StatusBox = (0, _styledComponents.default)(_ui.Box)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n"])));
exports.StatusBox = StatusBox;
const MediaSkeleton = (0, _styledComponents.default)(_ui.Skeleton).attrs({
  animated: true,
  radius: 2
...
const DescriptionSkeleton = (0, _styledComponents.default)(_ui.TextSkeleton).attrs({
  animated: true,
  radius: 1,
  size: 1
})(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  max-width: ", "; /* 90% of 200px */\n  width: 90%;\n"])), (0, _ui.rem)(180));
exports.DescriptionSkeleton = DescriptionSkeleton;
const DescriptionText = (0, _styledComponents.default)(_ui.Text)(_ref => {
  let {
    theme
  } = _ref;
  const {
