...
const DebugRect = _styledComponents.default.rect(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  stroke: #ccc;\n  fill: none;\n  pointer-events: none;\n  stroke-linecap: round;\n"])));

exports.DebugRect = DebugRect;

const ConnectorPath = _styledComponents.default.path(_ref => {
  let {
    theme
  } = _ref;
...
const InteractivePath = _styledComponents.default.path(_ref2 => {
  let {
    theme
  } = _ref2;
...
const RightBarWrapper = (0, _styledComponents.default)(_ClampedRect.ClampedRect)(_ref3 => {
  let {
    theme
  } = _ref3;
