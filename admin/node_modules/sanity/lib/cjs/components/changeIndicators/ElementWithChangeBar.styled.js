...
const ChangeBarWrapper = _styledComponents.default.div(_ref => {
  let {
    changed,
    disabled,
    isReviewChangeOpen
...
const FieldWrapper = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  min-width: 0;\n"])));

exports.FieldWrapper = FieldWrapper;

const ChangeBar = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  position: relative;\n  opacity: 1;\n  transition: opacity 100ms;\n  z-index: ", ";\n"])), _ref2 => {
  let {
    $zIndex
  } = _ref2;
  return $zIndex;
...
const ChangeBarMarker = _styledComponents.default.div(_ref3 => {
  let {
    theme
  } = _ref3;
...
const ChangeBarButton = _styledComponents.default.button(_ref4 => {
  let {
    theme,
    $withHoverEffect
  } = _ref4;
