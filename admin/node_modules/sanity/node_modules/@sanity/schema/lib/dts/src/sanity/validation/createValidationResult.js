...
export const error = (message, helpId) => createValidationResult('error', message, helpId);
export const warning = (message, helpId) => createValidationResult('warning', message, helpId);
export const info = (message, helpId) => createValidationResult('info', message, helpId);
