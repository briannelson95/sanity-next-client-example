...
PortableTextEditor.addAnnotation = (editor, type, value) => editor.editable?.addAnnotation(type, value);
PortableTextEditor.blur = (editor) => {
    debug('Host blurred');
    editor.editable?.blur();
};
PortableTextEditor.delete = (editor, selection, options) => editor.editable?.delete(selection, options);
...
PortableTextEditor.isCollapsedSelection = (editor) => editor.editable?.isCollapsedSelection();
PortableTextEditor.isExpandedSelection = (editor) => editor.editable?.isExpandedSelection();
PortableTextEditor.isMarkActive = (editor, mark) => editor.editable?.isMarkActive(mark);
...
PortableTextEditor.removeAnnotation = (editor, type) => editor.editable?.removeAnnotation(type);
