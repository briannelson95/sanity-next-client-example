...
describe('number', () => {
    ...
    test('precision constraint', async () => {
        ...
        await expect(rule.validate(Math.PI, context)).resolves.toMatchSnapshot('precision: invalid (pi)');
        await expect(rule.validate(31.133, context)).resolves.toMatchSnapshot('precision: valid (at limit)');
        await expect(rule.validate(31.3, context)).resolves.toMatchSnapshot('precision: valid (below limit)');
    });
