...
describe('child rules', () => {
    ...
    test('all() rules - single failure', async () => {
        ...
        await expect(rule.validate('moop', context)).resolves.toMatchSnapshot('all() rules - single failure, custom message');
    });
    test('all() rules - multiple failures', async () => {
        ...
        await expect(rule.validate('Sanity', context)).resolves.toMatchSnapshot('all() rules - match');
        await expect(rule.validate('moop', context)).resolves.toMatchSnapshot('all() rules - multiple failures, custom messages');
    });
    test('all() rules - single failure, custom, common error', async () => {
        ...
        await expect(rule.validate('moop', context)).resolves.toMatchSnapshot('all() rules - single failure, common error');
    });
    test('all() rules - single failure, custom, common error', async () => {
        const rule = Rule.string()
        ...
        await expect(rule.validate('moop', context)).resolves.toMatchSnapshot('all() rules - multiple failures, common error');
    });
    // --- EITHER ---
    test('either() rules - single failure', async () => {
        ...
        await expect(rule.validate('rgb(16, 22, 133)', context)).resolves.toMatchSnapshot('either() rules - match');
        await expect(rule.validate('#bf', context)).resolves.toMatchSnapshot('either() rules - single failure, custom message');
    });
    test('either() rules - all matches', async () => {
        ...
        await expect(rule.validate('Red', context)).resolves.toMatchSnapshot('either() rules - all match');
        await expect(rule.validate('nope', context)).resolves.toMatchSnapshot('either() rules - no matches');
    });
    test('either() rules - all fail, custom, common error', async () => {
        ...
        await expect(rule.validate('mopatis!', context)).resolves.toMatchSnapshot('either() rules - all fail, common error');
    });
});
