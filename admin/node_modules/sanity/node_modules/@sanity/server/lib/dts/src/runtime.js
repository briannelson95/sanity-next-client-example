...
import { decorateIndexWithAutoGeneratedWarning, getPossibleDocumentComponentLocations, renderDocument, } from './renderDocument';
/**
 ...
 * @internal
 */
export async function writeSanityRuntime({ cwd, watch }) {
