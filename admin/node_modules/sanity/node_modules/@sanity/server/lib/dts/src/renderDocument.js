        ...
        worker.on('message', (msg) => {
            if (msg.type === 'warning') {
                ...
                if (Array.isArray(msg.message)) {
                    msg.message.forEach((warning) => console.warn(`${chalk.yellow('[warn]')} ${warning}`));
                }
                else {
...
export function getPossibleDocumentComponentLocations(studioRootPath) {
...
function getDocumentComponent(studioRootPath) {
    ...
    const typeHint = typeof userDefined.component.default === 'undefined'
        ? ''
