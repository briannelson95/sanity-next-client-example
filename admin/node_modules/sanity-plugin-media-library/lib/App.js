...
var client = client_1.default.withConfig({ apiVersion: '2021-06-19' });
...
var App = function (_a) {
    var onClose = _a.onClose, onSelect = _a.onSelect, selectedAssets = _a.selectedAssets, tool = _a.tool, mode = _a.mode;
    var _b = (0, react_1.useState)([]), activeExtensions = _b[0], setActiveExtensions = _b[1];
    var _c = (0, react_1.useState)([]), activeTags = _c[0], setActiveTags = _c[1];
    var _d = (0, react_1.useState)([]), assets = _d[0], setAssets = _d[1];
    var _e = (0, react_1.useState)(null), assetsToDelete = _e[0], setAssetsToDelete = _e[1];
    var _f = (0, react_1.useState)(null), assetToEdit = _f[0], setAssetToEdit = _f[1];
    var _g = (0, react_1.useState)(assets), filteredAssets = _g[0], setFilteredAssets = _g[1];
    var _h = (0, react_1.useState)(false), isDraggingMediaItem = _h[0], setIsDraggingMediaItem = _h[1];
    var _j = (0, react_1.useState)(true), loading = _j[0], setLoading = _j[1];
    var _k = (0, react_1.useState)([]), localSelectedAssets = _k[0], setLocalSelectedAssets = _k[1];
    var _l = (0, react_1.useState)(''), searchQuery = _l[0], setSearchQuery = _l[1];
    var _m = (0, react_1.useState)('date'), sort = _m[0], setSort = _m[1];
    var toast = (0, ui_1.useToast)();
    var types = tool ? '"sanity.imageAsset", "sanity.fileAsset"' : '"sanity.imageAsset"';
    var includedFields = __spreadArray([
        '_createdAt',
        '_id',
        '_type',
        'alt',
    ...
    (0, react_1.useEffect)(function () {
        var newFilteredAssets = __spreadArray([], assets, true);
        if (searchQuery && searchQuery !== '') {
            newFilteredAssets = newFilteredAssets.filter(function (_a) {
                ...
                return [originalFilename, title, alt, tags === null || tags === void 0 ? void 0 : tags.join('')].some(function (value) { return (value === null || value === void 0 ? void 0 : value.toUpperCase().indexOf(searchQuery.toUpperCase())) > -1; });
            });
        }
    ...
    (0, react_1.useEffect)(function () {
        ...
        var assetsToSelect = __spreadArray([], assets, true).filter(function (_a) {
            var _id = _a._id;
            return selectedAssetsIds.indexOf(_id) > -1;
        });
        setLocalSelectedAssets(assetsToSelect);
    }, [assets, selectedAssets]);
    (0, react_1.useEffect)(subscribeToAssetChanges, []);
    (0, react_1.useEffect)(function () {
        fetchAssets();
    }, []);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        setLoading(true);
                        return [4 /*yield*/, client.fetch(query, {})];
                    case 1:
                        newAssets = _a.sent();
                        setAssets(newAssets);
                        return [3 /*break*/, 4];
    ...
    function subscribeToAssetChanges() {
        var subscription = client
            ...
            if (transition === 'disappear') {
                return setAssets(function (assets) { return __spreadArray([], assets, true).filter(function (_a) {
                    var _id = _a._id;
                    return _id !== documentId;
                }); });
            }
            if (transition === 'update') {
                return setAssets(function (assets) { return __spreadArray([], assets, true).map(function (asset) { return (asset._id === documentId ? result : asset); }); });
            }
            if (transition === 'appear') {
                return setAssets(function (assets) { return __spreadArray(__spreadArray([], assets, true), [result], false); });
            }
        });
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(filesWithAllowedFileType_1.map(function (file) {
                                return client.assets.upload(file.type.indexOf('image') > -1 ? 'image' : 'file', file);
                            }))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        idsWithNewTags = idsAndTags.map(function (_a) {
                            ...
                            return ({
                                _id: _id,
                                tags: (tags === null || tags === void 0 ? void 0 : tags.includes(tag)) ? tags : __spreadArray(__spreadArray([], (tags || []), true), [tag], false),
                            });
                        });
                        return [4 /*yield*/, Promise.all(idsWithNewTags.map(function (_a) {
                                var _id = _a._id, tags = _a.tags;
                                return client.patch(_id).set({ tags: tags }).commit();
                            }))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
    ...
    var extensions = getUniqueFiltersWithActive(assets, activeExtensions, function (acc, _a) {
        var extension = _a.extension;
        return __spreadArray(__spreadArray([], acc, true), [extension], false);
    });
    var tags = __spreadArray([
        ...
        var tags = _a.tags;
        return (tags ? __spreadArray(__spreadArray([], acc, true), tags, true) : acc);
    }), true);
    return (react_1.default.createElement(StyledContainer, null,
        react_1.default.createElement(ui_1.Card, { style: { height: '100%' } },
            react_1.default.createElement(UploadDropArea_1.UploadDropArea, { disabled: isDraggingMediaItem, loading: loading, onUpload: onUpload },
                react_1.default.createElement(StyledSidebarGridContainer, null,
                    mode === 'tool' && (react_1.default.createElement(Sidebar_1.Sidebar, { extensions: extensions, loading: loading, onClearFilters: onClearFilters, onExtensionClick: onExtensionClick, onTagClick: onTagClick, onTagDrop: onTagDrop, onUpload: onUpload, tags: tags })),
                ...
                mode === 'tool' && (react_1.default.createElement(react_1.default.Fragment, null,
...
function onFilterClick(value, stateValue, setStateValue) {
    ...
    if (index === -1) {
        return setStateValue(__spreadArray(__spreadArray([], stateValue, true), [value], false));
    }
    var newValues = __spreadArray([], stateValue, true);
