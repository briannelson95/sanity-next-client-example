...
var MediaLibrary = function (_a) {
    ...
    var _c = (0, react_1.useState)('grid'), viewType = _c[0], setViewType = _c[1];
    function onMediaItemClick(e, asset) {
        ...
        if (!isAssetSource && e.shiftKey && selectedAssets.length > 0) {
            ...
            var newSelectedAssets = __spreadArray([], assets, true).slice(indexes[0], indexes[1] + 1);
        ...
        if (!isAssetSource && (e.ctrlKey, e.metaKey) && selectedAssets.length > 0) {
            if (indexInSelectedAssets > -1) {
                var newSelectedAssets = __spreadArray([], selectedAssets, true);
                newSelectedAssets.splice(indexInSelectedAssets, 1);
                return setSelectedAssets(newSelectedAssets);
            }
            else {
                var newSelectedAssets = Array.from(new Set(__spreadArray(__spreadArray([], selectedAssets, true), [asset], false)));
                return setSelectedAssets(newSelectedAssets);
            }
        }
        if (indexInSelectedAssets > -1) {
    ...
    function onDragStart(asset) {
        if (!selectedAssets.includes(asset)) {
            setSelectedAssets(__spreadArray(__spreadArray([], selectedAssets, true), [asset], false));
        }
    }
    ...
    return (react_1.default.createElement(StyledContainer, null,
        ...
        react_1.default.createElement(StyledFlexGrowContainer, null,
            react_1.default.createElement(StyledMediaGridContainer, null, !Boolean(assets.length) && !loading ? (react_1.default.createElement(ui_1.Box, { padding: 3, id: "noContent" },
                react_1.default.createElement(ui_1.Card, { padding: [3, 3, 4], radius: 2, shadow: 1 },
                    react_1.default.createElement(ui_1.Text, { size: 3 }, "No assets found")))) : (react_1.default.createElement(ViewElement, { assets: assets, onDoubleClick: onDoubleClick, onDragStart: onDragStart, onMediaItemClick: onMediaItemClick, selectedAssets: selectedAssets, setIsDraggingMediaItem: setIsDraggingMediaItem })))),
