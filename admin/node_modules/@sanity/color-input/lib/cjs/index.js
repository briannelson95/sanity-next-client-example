...
const $f424886802e2a804$export$4e4b8c12b77623c0 = {
...
const $6707e7c5509edbba$export$cc215b4b2c268dfd = {
...
function $50859b401fad6cb5$export$5a1d7ca0a925d9c2(props) {
    ...
    const emitSetColor = (0, $k7rGe$react.useCallback)((nextColor)=>{
        const fieldPatches = type.fields.filter((field)=>field.name in nextColor).map((field)=>{
            ...
            return (0, $k7rGe$sanityform.set)(isObject ? Object.assign({
        ...
        onChange([
            ...
            (0, $k7rGe$sanityform.set)(type.name, [
                "_type"
            ]),
            (0, $k7rGe$sanityform.set)(nextColor.rgb?.a, [
                "alpha"
            ]),
            ...fieldPatches, 
        ]);
...
const $1ba04456571fe4ef$export$35e9368ef982300f = {
    name: "color",
    type: "object",
    title: "Color",
    components: {
...
const $ebd6b32193e371d0$export$633851ea6f85c81b = {
    title: "Hue Saturation Value",
    name: "hsvaColor",
    type: "object",
    fields: [
