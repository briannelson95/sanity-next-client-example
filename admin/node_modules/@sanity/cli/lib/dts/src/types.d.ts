...
export declare type CliCommandAction<F = Record<string, unknown>> = (args: CliCommandArguments<F>, context: CliCommandContext) => Promise<unknown>;
...
export declare type SinglePrompt = (Omit<DistinctQuestion, 'name'> & {
    type: 'list';
...
export declare type CliPrompter = (<T extends Answers = Answers>(questions: DistinctQuestion<T>[]) => Promise<T>) & {
