import { getPackageManagerChoice, installDeclaredPackages, installNewPackages, } from '../../packageManager';
const installCommand = {
    ...
    action: async (args, context) => {
        ...
        if (packages.length > 0) {
            await installNewPackages({ packageManager: pkgManager.chosen, packages: args.argsWithoutOptions }, context);
        }
        else {
