...
import { createStudioConfig } from './createStudioConfig';
import templates from './templates';
export async function bootstrapTemplate(opts, context) {
    ...
    await Promise.all([
        ...
        writeFileIfNotExists('.eslintrc', `${JSON.stringify({ extends: '@sanity/eslint-config-studio' }, null, 2)}\n`),
    ]);
