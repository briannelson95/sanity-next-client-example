...
export declare type ListenMessageData = ListenSecret | ListenUrl | ListenToken;
export declare type ListenFailureMessage = ListenRequestError | ListenTimeout | GenericListenError;
