...
const datasetNameError = 'Dataset names can only contain lowercase characters,' +
    'numbers, underscores and dashes' +
    `and can be at most ${MAX_DATASET_NAME_LENGTH} characters.`;
export function promptForDatasetName(prompt, options = {}, existingDatasets = []) {
...
function formatInvalid(name, invalid) {
    return invalid.reduce((acc, char) => acc.replace(new RegExp(escapeRegex(char), 'g'), chalk.red.bold(char)), name);
}
