...
export async function bootstrapFromTemplate(context, url) {
    const { prompt, workDir } = context;
    let inProjectContext = false;
    try {
        const projectManifest = await readJson(path.join(workDir, 'sanity.json'));
...
//# sourceMappingURL=bootstrapFromTemplate.js.map