...
export class CommandRunner {
    ...
    async runCommand(commandOrGroup, args, options) {
        ...
        const apiClient = getClientWrapper(cliConfig?.config?.api || null, cliConfig?.path || (cliConfig?.version === 2 ? 'sanity.json' : 'sanity.cli.js'));
        const context = {
            output,
            prompt,
            apiClient,
...
export function getCliRunner(commands) {
