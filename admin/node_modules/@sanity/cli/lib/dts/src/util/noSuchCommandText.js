...
export function getNoSuchCommandText(cmdName, parentGroupName, groups) {
...
function suggestCommand(cmdName, group, parentGroupName = null) {
    ...
    const closest = group
        ...
        .reduce((current, distance, index) => distance < current.distance ? { index, distance } : current, { index: 0, distance: +Infinity });
...
//# sourceMappingURL=noSuchCommandText.js.map